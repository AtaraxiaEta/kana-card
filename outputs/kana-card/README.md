...
- 阶段 1：46 个基础清音假名。
- 阶段 2：が、ざ、だ、ば、ぱ 五行，共 25 种浊音和半浊音。
- 基础假名全部接触且至少 80% 达到 7 天复习间隔后，自动解锁阶段 2。
- 五十音图可以提前查看阶段 2 内容，但正式出题会等待解锁。

## 完整阶段

- 阶段 3：33 个常见拗音，例如 きゃ、しゃ、ちゃ、じゃ。
- 阶段 4：长音与促音规则，通过真实短词练习。
- 每个阶段在上一阶段全部接触且至少 80% 达到 7 天复习间隔后解锁。
- 五十音图可切换基础、浊音、拗音和规则进行预览。
